...
2. Load the component using the Kubeflow pipeline's SDK:
    ...
    dataproc_submit_hadoop_job_op = comp.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/1.0.0-test-1/components/gcp/dataproc/submit_hadoop_job/component.yaml')
