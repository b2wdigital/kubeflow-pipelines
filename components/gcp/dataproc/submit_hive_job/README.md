...
2. Load the component using the Kubeflow pipeline's SDK:
    ...
    dataproc_submit_hive_job_op = comp.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/1.0.0-test-2/components/gcp/dataproc/submit_hive_job/component.yaml')
