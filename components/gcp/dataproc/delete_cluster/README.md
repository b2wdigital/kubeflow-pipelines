...
2. Load the component using the Kubeflow pipeline's SDK:
    ...
    dataproc_delete_cluster_op = comp.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/1.0.0-test-2/components/gcp/dataproc/delete_cluster/component.yaml')
